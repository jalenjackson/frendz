...
export default class SignUpFormNameScreen extends Component {
    ...
    return (
      <View style={ styles.mainBackground }>
        <View style={{ flex: 1, flexDirection: 'column', alignItems: 'center' }}>
          ...
          <TextInput style={ styles.textInput } placeholder="What's your name" onChangeText={ this.setTextInputState.bind(this) } />
